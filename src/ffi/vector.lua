...
ffi.cdef[[
  typedef struct vector2 { double x, y, z ;} vector2_t;
]]
...
local mt = {
  __add = function ( a, b ) return vector2 ( a.x + b.x, a.y + b.y, a.z + b.z ) end,
  __sub = function ( a, b ) return vector2 ( a.x - b.x, a.y - b.y, a.z - b.z ) end,
  __mul = function ( a, b )
    local isnum = type ( b ) == 'number'
    return vector2 ( a.x * ( isnum and b or b.x ), a.y * ( isnum and b or b.y ), a.z * ( isnum and b or b.z ) )
  end,
  __div = function ( a, b )
    local isnum = type ( b ) == 'number'
    return vector2 ( a.x / ( isnum and b or b.x ), a.y / ( isnum and b or b.y ), a.z / ( isnum and b or b.z ) )
  ...
  __index = {
    ...
    unit = function ( a )
      local l = #a
      return vector2 ( a.x / l, a.y / l, a.z / l )
    end,
    rotate = function ( a, r )
  ...
  __lt= function ( a, b ) return a.x < b.x or ( a.x == b.x and a.y < b.y and a.z < b.z ) end,
  __le = function ( a, b ) return a.x <= b.x and a.y <= b.y and a.z <= b.z end,
  __tostring = function ( a ) return 'Vector ' .. a.x .. ':' .. a.y .. ':' .. a.z end,
}
